...
export const getButtonClassName = (invertColor: boolean = false): string =>
  clsx(
    `${lexend.className} flex gap-2 items-center border-[1px]  text-[17px]  py-[10px] px-[20px] md:py-[10px] md:px-[30px] rounded-[45px]  easy-in duration-300 hover:cursor-pointer shadow-sm`,
    {
